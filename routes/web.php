...
Route::prefix('admin')->group(function(){
  ...
  //Update Data
  Route::get('/updateLaporan', 'AdminController@updateData')->name('updateData');
});

Route::prefix('peneliti')->group(function(){
  //Monitor Lokasi
  Route::get('/home/({id_cabang})', 'PenelitiController@lihatChartPeneliti')->name('penelitilihat.agam');
